...
build_all() {
  declare -A targets=(
    ...
    ["dotnet"]="containerfiles/dotnet.Dockerfile"
...
if [[ $# -lt 1 ]]; then
  echo "Usage: $0 {box|dotnet|python|engine|all} [ARCH]"
...
"box")
  ...
  ;;
"dotnet")
  build "dotnet" "containerfiles/dotnet.Dockerfile" "$push"
  ;;
"python")
